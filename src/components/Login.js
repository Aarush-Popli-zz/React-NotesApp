            ...
            <div className="card">
                ...
                <div className="card-body">
                    <form className='g-1' onSubmit={handleSubmit}>
                        ...
                        <div className="form-floating mb-3">
                            <input type="password" className="form-control" name='password' id="authPassword" value={credentials.password} onChange={onChange} placeholder="Enter password" required/>
                            <label htmlFor="authPassword" className="form-label">Password</label>
                        </div>
                        <button type="submit" className="btn btn-primary col-md-2 float-end">Log In</button>
                    </form>
                </div>
            </div>
        </div>
